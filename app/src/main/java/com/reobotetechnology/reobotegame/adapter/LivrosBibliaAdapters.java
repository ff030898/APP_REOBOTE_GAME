...
public class LivrosBibliaAdapters extends RecyclerView.Adapter<LivrosBibliaAdapters.myViewHolder> {


    private List<LivrosBibliaModel> biblia;
    private Context context;

    public LivrosBibliaAdapters(List<LivrosBibliaModel> listaBiblia, Context c) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemLista = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycler_livros_biblia, parent, false);
