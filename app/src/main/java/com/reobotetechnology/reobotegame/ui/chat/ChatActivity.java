package com.reobotetechnology.reobotegame.ui.chat;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (nome.equals("Reobote Technology")) {
            ...
            try {
                Picasso.get().load(R.drawable.reobote).into(imagemUsuarioConversa);
            } catch (Exception e) {
                Picasso.get().load(R.drawable.reobote).into(imagemUsuarioConversa);
            }
            ...
            UsuarioModel amigo = new UsuarioModel("1", "Fabrício", "", "",
                    ...
                    0,0,0,true, false);
            try {
                Picasso.get().load(imagem).into(imagemUsuarioConversa);
            } catch (Exception e) {
                Picasso.get().load(R.drawable.user).into(imagemUsuarioConversa);
            }
            MensagensModel m = new MensagensModel(1, amigo, amigo, data, hora_atual,
