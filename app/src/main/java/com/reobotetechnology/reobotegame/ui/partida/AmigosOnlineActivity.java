...
public class AmigosOnlineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Convidar Amigo");
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                if (usuarioSelecionado.isJogando()) {
                                    ...
                                    Intent i = new Intent(getApplicationContext(), CarregarPartidaActivity.class);
